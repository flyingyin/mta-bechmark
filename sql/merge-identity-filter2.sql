        ...
        FROM (
            ...
            FROM (
                ...
                WHERE ati.action_tag_fbid IN (11152200942590)
                    ...
                    AND ((cce.category IN (2) AND cce.event_ts between 1460444400 and 1463036400) OR (cce.category IN (3, 5) AND cce.event_ts between 1457852400 and 1463036400) OR (cce.category IN (0) AND cce.event_ts between 1460012400 and 1463036400))
