    ...
    FROM (
        ...
        FROM (
            ...
            FROM (
                SELECT
                    ...
                    ati.hashed_fbid AS internal_hashed_fbid,
                    ...
                    ati.action_tag_fbid AS internal_action_tag_fbid,
                ...
                JOIN conversion_contributor_event cce ON advti.hashed_fbid = cce.hashed_fbid
        ...
        FROM (
            ...
            FROM (
                ...
                FROM (
                    SELECT
                        ati.native_identity_provider AS internal_native_identity_provider,
                        ati.native_identity_value AS internal_native_identity_value,
                        cce.audience_fbid AS audience_id,
                        cce.device_type AS device_type,
                        (CASE WHEN category IN (0, 3, 5) THEN event_ts ELSE 0 END) AS internal_contributor_event_ts,
                        cce.ad_event_fbid AS ad_event_id,
                    ...
                    JOIN conversion_contributor_event cce ON advti.native_identity_provider = cce.native_identity_provider AND advti.native_identity_value = cce.native_identity_value
                WHERE ati.action_tag_fbid IN (11152200942590)
                    AND advti.advertiser_fbid IN (11152200768503)
                        AND cce.action_tag_fbid IN (11152200942590, 0)
                        AND cce.advertiser_fbid IN (11152200768503)
